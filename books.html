...
<title>Books — Toddler Kitties</title>
<meta name="description" content="Four hand-drawn origin storybooks — Baker, Doc, Lulu and Ilona — plus the ensemble book, The Cat Council.">
<link rel="canonical" href="https://toddlerkitties.com/books.html">
...
<meta property="og:title" content="Books — Toddler Kitties">
<meta property="og:description" content="Four hand-drawn origin storybooks — Baker, Doc, Lulu and Ilona — plus the ensemble book, The Cat Council.">
<meta property="og:url" content="https://toddlerkitties.com/books.html">
<meta name="twitter:card" content="summary_large_image">
<link rel="icon" href="data:image/svg+xml;base64," type="image/svg+xml">
<link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Baloo+2:wght@500;700;800&family=Nunito:ital,wght@0,400;0,600;0,700;1,400&display=swap">
<style>/* ==========================================================================
   Toddler Kitties
...
<svg xmlns="http://www.w3.org/2000/svg" width="0" height="0" style="position:absolute" aria-hidden="true" focusable="false">
  ...
  <!-- ============ BAKER — B1 — grey-brown tabby, heart nose, pointed ears ============ -->
  <symbol id="tk-baker" viewBox="-6 -6 152 152">
    <g>
      <!-- tail -->
      <path d="M96 128 C124 126 130 108 120 92" fill="none" stroke="#6E6055" stroke-width="11" stroke-linecap="round"/>
      <path d="M96 128 C124 126 130 108 120 92" fill="none" stroke="#9C8C7E" stroke-width="7" stroke-linecap="round"/>
      <path d="M118 96 l9 5 M112 108 l10 3" stroke="#6E6055" stroke-width="4" stroke-linecap="round"/>
      <!-- body -->
      <path d="M20 138 C20 106 37 94 60 94 C83 94 100 106 100 138 Z" fill="#9C8C7E"/>
      <ellipse cx="60" cy="130" rx="19" ry="15" fill="#EFE3D2"/>
      <!-- ears (tall, pointed, sassy) -->
      <path d="M27 44 L17 2 L53 28 Z" fill="#9C8C7E"/>
      <path d="M93 44 L103 2 L67 28 Z" fill="#9C8C7E"/>
      <path d="M31 39 L25 13 L46 28 Z" fill="#E0A6A6"/>
      <path d="M89 39 L95 13 L74 28 Z" fill="#E0A6A6"/>
      <!-- head -->
      <ellipse cx="60" cy="58" rx="41" ry="36" fill="#9C8C7E"/>
      <!-- forehead stripes -->
      <path d="M60 24 v12 M48 27 l3 11 M72 27 l-3 11" stroke="#6E6055" stroke-width="4.5" stroke-linecap="round"/>
      <path d="M26 52 q8 3 13 0 M94 52 q-8 3 -13 0" stroke="#6E6055" stroke-width="4" stroke-linecap="round" fill="none"/>
      <!-- muzzle -->
      <ellipse cx="60" cy="74" rx="17" ry="12" fill="#EFE3D2"/>
      <!-- half-lidded eyes -->
      <path d="M37 57 C37 66 51 66 51 57 Z" fill="#7C9A4E"/>
      <path d="M69 57 C69 66 83 66 83 57 Z" fill="#7C9A4E"/>
      <g class="bk-pupils"><path d="M42 60 C42 65 46 65 46 60 Z" fill="#241F2E"/><path d="M74 60 C74 65 78 65 78 60 Z" fill="#241F2E"/></g>
      <path d="M36 56 Q44 51 52 56 M68 56 Q76 51 84 56" stroke="#241F2E" stroke-width="3" stroke-linecap="round" fill="none"/>
      <!-- heart nose -->
      <path d="M60 71.5 C56.5 66.5 50 67.5 50 72 C50 76.6 56.5 79.2 60 83 C63.5 79.2 70 76.6 70 72 C70 67.5 63.5 66.5 60 71.5 Z" fill="#D96A7A"/>
      <!-- little frown -->
      <path d="M52 90 Q60 85.5 68 90" stroke="#241F2E" stroke-width="2.6" stroke-linecap="round" fill="none"/>
      <!-- collar on chest + B tag -->
      <path d="M33 105 Q60 119 87 105" fill="none" stroke="#7E5BA6" stroke-width="9" stroke-linecap="round"/>
      <circle cx="60" cy="122" r="9" fill="#E8DAF6"/>
      <text x="60" y="126" text-anchor="middle" font-family="monospace" font-size="11" font-weight="700" fill="#5B3E82">B</text>
    </g>
  </symbol>

  <!-- ============ DOC — D2 — cow-patterned, huge ears, moon-and-stars collar ============ -->
  <symbol id="tk-doc" viewBox="-6 -6 152 152">
    <g>
      <!-- tail: black with a white tip -->
      <path d="M98 130 C126 128 132 110 122 94" fill="none" stroke="#2A2730" stroke-width="11" stroke-linecap="round"/>
      <path d="M124 103 C124 99 123 96 122 94" fill="none" stroke="#FAF7F2" stroke-width="11" stroke-linecap="round"/>
      <!-- body: black, white chest + a white shoulder patch -->
      <path d="M20 138 C20 106 37 94 60 94 C83 94 100 106 100 138 Z" fill="#2A2730"/>
      <ellipse cx="60" cy="130" rx="19" ry="15" fill="#FAF7F2"/>
      <ellipse cx="30" cy="121" rx="7" ry="9" fill="#FAF7F2"/>
      <!-- ears (very large, upright) -->
      <path d="M24 42 L12 0 L54 26 Z" fill="#2A2730"/>
      <path d="M96 42 L108 0 L66 26 Z" fill="#2A2730"/>
      <path d="M29 37 L21 10 L45 26 Z" fill="#D98F96"/>
      <path d="M91 37 L99 10 L75 26 Z" fill="#D98F96"/>
      <!-- head: black -->
      <ellipse cx="60" cy="58" rx="41" ry="36" fill="#2A2730"/>
      <!-- white blaze between the eyes -->
      <path d="M60 23 L52 64 L68 64 Z" fill="#FAF7F2"/>
      <!-- white muzzle -->
      <ellipse cx="60" cy="75" rx="18" ry="12" fill="#FAF7F2"/>
      <!-- eyes, yellow-green -->
      <circle cx="43" cy="56" r="8" fill="#C6D24A"/>
      <circle cx="77" cy="56" r="8" fill="#C6D24A"/>
      <ellipse cx="43" cy="56" rx="3.4" ry="6" fill="#241F2E"/>
      <ellipse cx="77" cy="56" rx="3.4" ry="6" fill="#241F2E"/>
      <circle cx="45" cy="53" r="1.8" fill="#FAF7F2"/>
      <circle cx="79" cy="53" r="1.8" fill="#FAF7F2"/>
      <!-- nose + open, talking mouth -->
      <path d="M55 70 h10 l-5 5 Z" fill="#5C4148"/>
      <ellipse cx="60" cy="84" rx="6" ry="5" fill="#5C4148"/>
      <!-- collar: navy, moon and stars -->
      <path d="M33 105 Q60 119 87 105" fill="none" stroke="#23407E" stroke-width="9" stroke-linecap="round"/>
      <path d="M45 110 l1.6 3.6 3.9 .4 -2.9 2.6 .8 3.8 -3.4 -2 -3.4 2 .8 -3.8 -2.9 -2.6 3.9 -.4 Z" fill="#E8C33D"/>
      <path d="M78 108 a4.6 4.6 0 1 0 3.6 7.4 a3.6 3.6 0 1 1 -3.6 -7.4 Z" fill="#E8C33D"/>
      <circle cx="62" cy="115" r="1.9" fill="#E8C33D"/>
    </g>
  </symbol>

  <!-- ============ LULU — L3 — greyish-brown tortie, daisy collar ============ -->
  <symbol id="tk-lulu" viewBox="-6 -6 152 152">
    <g>
      <!-- tail -->
      <path d="M96 128 C124 126 130 108 120 92" fill="none" stroke="#8B7A6C" stroke-width="11" stroke-linecap="round"/>
      <path d="M122 96 c6 6 4 12 -1 14" fill="none" stroke="#A9714A" stroke-width="9" stroke-linecap="round"/>
      <!-- body -->
      <path d="M20 138 C20 106 37 94 60 94 C83 94 100 106 100 138 Z" fill="#8B7A6C"/>
      <path d="M20 138 C20 116 28 100 44 96 L46 138 Z" fill="#5E4E44"/>
      <ellipse cx="84" cy="124" rx="10" ry="12" fill="#A9714A"/>
      <ellipse cx="60" cy="132" rx="16" ry="12" fill="#EFE3D2"/>
      <!-- ears -->
      <path d="M26 42 L18 5 L53 27 Z" fill="#8B7A6C"/>
      <path d="M94 42 L102 5 L67 27 Z" fill="#A9714A"/>
      <path d="M30 37 L25 15 L45 27 Z" fill="#E0A6A6"/>
      <path d="M90 37 L95 15 L75 27 Z" fill="#E0A6A6"/>
      <!-- head -->
      <ellipse cx="60" cy="58" rx="41" ry="36" fill="#8B7A6C"/>
      <!-- tortie mottling -->
      <path d="M60 22 C78 22 94 32 98 50 C88 56 74 52 66 42 C62 36 60 28 60 22 Z" fill="#A9714A"/>
      <path d="M22 48 C26 33 38 24 52 22 C50 34 44 44 34 52 Z" fill="#5E4E44"/>
      <path d="M92 66 q6 6 4 12" stroke="#5E4E44" stroke-width="4" stroke-linecap="round" fill="none"/>
      <!-- muzzle -->
      <ellipse cx="60" cy="74" rx="17" ry="12" fill="#EFE3D2"/>
      <!-- eyes, soft green, wide and deep -->
      <circle cx="43" cy="57" r="8.5" fill="#6E9A5A"/>
      <circle cx="77" cy="57" r="8.5" fill="#6E9A5A"/>
      <circle cx="43" cy="57" r="4" fill="#241F2E"/>
      <circle cx="77" cy="57" r="4" fill="#241F2E"/>
      <circle cx="45.5" cy="54" r="2" fill="#FFFFFF"/>
      <circle cx="79.5" cy="54" r="2" fill="#FFFFFF"/>
      <!-- nose + gentle mouth -->
      <path d="M55 70 h10 l-5 5.5 Z" fill="#D96A7A"/>
      <path d="M60 76 q-5 5 -9 1 M60 76 q5 5 9 1" stroke="#5E4E44" stroke-width="2.4" stroke-linecap="round" fill="none"/>
      <!-- collar: green with white daisies -->
      <path d="M33 105 Q60 119 87 105" fill="none" stroke="#2F6B44" stroke-width="9" stroke-linecap="round"/>
      <g fill="#FFFFFF">
        <circle cx="44" cy="110.5" r="1.9"/><circle cx="47.6" cy="110.5" r="1.9"/><circle cx="45.8" cy="107.6" r="1.9"/><circle cx="45.8" cy="113.4" r="1.9"/>
        <circle cx="72" cy="112.5" r="1.9"/><circle cx="75.6" cy="112.5" r="1.9"/><circle cx="73.8" cy="109.6" r="1.9"/><circle cx="73.8" cy="115.4" r="1.9"/>
      </g>
      <circle cx="45.8" cy="110.5" r="1.7" fill="#E8C33D"/>
      <circle cx="73.8" cy="112.5" r="1.7" fill="#E8C33D"/>
      <circle cx="60" cy="115.5" r="6.5" fill="#F2F2E8"/>
      <text x="60" y="119.4" text-anchor="middle" font-family="monospace" font-size="9" font-weight="700" fill="#2F6B44">L</text>
    </g>
  </symbol>

  <!-- ============ ILONA — I4 — long-haired orange/cream tabby, plume tail, bow tie ============ -->
  <symbol id="tk-ilona" viewBox="-6 -6 152 152">
    <g>
      <!-- plume tail -->
      <path d="M96 132 C122 132 136 112 126 88 C134 106 124 120 108 122 C120 116 124 104 118 96 C120 110 106 118 94 120 Z" fill="#E0A05A"/>
      <path d="M124 94 c4 8 2 14 -3 18" stroke="#C2803E" stroke-width="4" stroke-linecap="round" fill="none"/>
      <!-- body with long-hair edge -->
      <path d="M18 138 C18 121 23 107 34 100 q-4 5 -3 7 q5 -7 10 -9 q-3 4 -2 6 q6 -6 11 -8 C48 94 54 94 60 94 C83 94 102 106 102 138 Z" fill="#E0A05A"/>
      <ellipse cx="60" cy="130" rx="20" ry="16" fill="#F6E2C4"/>
      <path d="M24 122 q9 3 0 6 M96 118 q-9 3 0 6" stroke="#C2803E" stroke-width="4" stroke-linecap="round" fill="none"/>
      <!-- big ears with tufts -->
      <path d="M24 42 L14 2 L53 26 Z" fill="#E0A05A"/>
      <path d="M96 42 L106 2 L67 26 Z" fill="#E0A05A"/>
      <path d="M29 37 L22 12 L45 26 Z" fill="#E8AFAF"/>
      <path d="M91 37 L98 12 L75 26 Z" fill="#E8AFAF"/>
      <path d="M27 30 l-6 -6 M31 24 l-5 -8 M93 30 l6 -6 M89 24 l5 -8" stroke="#F6E2C4" stroke-width="3" stroke-linecap="round"/>
      <!-- head -->
      <ellipse cx="60" cy="58" rx="42" ry="37" fill="#E0A05A"/>
      <!-- tabby stripes -->
      <path d="M60 22 v13 M47 25 l3 11 M73 25 l-3 11" stroke="#C2803E" stroke-width="4.5" stroke-linecap="round"/>
      <path d="M25 50 q9 3 14 0 M95 50 q-9 3 -14 0" stroke="#C2803E" stroke-width="4" stroke-linecap="round" fill="none"/>
      <!-- muzzle -->
      <ellipse cx="60" cy="75" rx="18" ry="12.5" fill="#F6E2C4"/>
      <!-- huge amber-gold eyes -->
      <circle cx="42" cy="57" r="9.5" fill="#D8912A"/>
      <circle cx="78" cy="57" r="9.5" fill="#D8912A"/>
      <ellipse cx="42" cy="57" rx="4" ry="8" fill="#241F2E"/>
      <ellipse cx="78" cy="57" rx="4" ry="8" fill="#241F2E"/>
      <circle cx="45" cy="53" r="2.3" fill="#FFFFFF"/>
      <circle cx="81" cy="53" r="2.3" fill="#FFFFFF"/>
      <!-- nose + mid-sentence mouth -->
      <path d="M55 70 h10 l-5 5 Z" fill="#D96A7A"/>
      <ellipse cx="60" cy="83" rx="7" ry="6" fill="#C4626E"/>
      <!-- collar: yellow with black-and-white bow tie -->
      <path d="M33 105 Q60 119 87 105" fill="none" stroke="#E8C33D" stroke-width="9" stroke-linecap="round"/>
      <path d="M60 115 L47 108 L47 122 Z" fill="#241F2E"/>
      <path d="M60 115 L73 108 L73 122 Z" fill="#241F2E"/>
      <rect x="55.5" y="110.5" width="9" height="9" rx="2.5" fill="#FAF7F2"/>
    </g>
  </symbol>

  <!-- ============ sleeping loafs (header) ============ -->
  <symbol id="tk-sleep-baker" viewBox="0 0 96 56">
    <ellipse cx="44" cy="38" rx="33" ry="15" fill="#9C8C7E"/>
    <path d="M14 44 q20 9 38 3" stroke="#6E6055" stroke-width="6" stroke-linecap="round" fill="none"/>
    <circle cx="68" cy="29" r="15" fill="#9C8C7E"/>
    <path d="M58 19 L55 6 L67 13 Z" fill="#9C8C7E"/><path d="M78 19 L81 6 L69 13 Z" fill="#9C8C7E"/>
    <path d="M66 12 v6 M61 13 l2 5 M71 13 l-2 5" stroke="#6E6055" stroke-width="2.4" stroke-linecap="round"/>
    <path d="M60 29 q3 3 6 0 M71 29 q3 3 6 0" stroke="#3B2E4A" stroke-width="2.2" fill="none" stroke-linecap="round"/>
    <path d="M68 35 c-1.4 -2.2 -3.8 -1.7 -3.8 0 c0 1.7 2.4 2.6 3.8 4 c1.4 -1.4 3.8 -2.3 3.8 -4 c0 -1.7 -2.4 -2.2 -3.8 0 Z" fill="#D96A7A"/>
    <text x="84" y="16" font-size="12" font-weight="800" fill="#3B2E4A">z</text>
    <text x="89" y="8" font-size="8" font-weight="800" fill="#3B2E4A">z</text>
  </symbol>
  <symbol id="tk-sleep-doc" viewBox="0 0 96 56">
    <ellipse cx="44" cy="38" rx="33" ry="15" fill="#2A2730"/>
    <ellipse cx="34" cy="43" rx="9" ry="6" fill="#FAF7F2"/>
    <ellipse cx="52" cy="46" rx="5" ry="4" fill="#FAF7F2"/>
    <path d="M14 44 q20 9 38 3" stroke="#2A2730" stroke-width="6" stroke-linecap="round" fill="none"/>
    <path d="M14.5 44.2 q3 1.4 6 2.2" stroke="#FAF7F2" stroke-width="6" stroke-linecap="round" fill="none"/>
    <circle cx="68" cy="29" r="15" fill="#2A2730"/>
    <path d="M68 15 L64.5 27 L71.5 27 Z" fill="#FAF7F2"/>
    <ellipse cx="68" cy="35" rx="8" ry="5.5" fill="#FAF7F2"/>
    <path d="M57 18 L52 3 L66 10 Z" fill="#2A2730"/><path d="M79 18 L84 3 L70 10 Z" fill="#2A2730"/>
    <path d="M59 28 q3 3 6 0 M71 28 q3 3 6 0" stroke="#F4EFFF" stroke-width="2.2" fill="none" stroke-linecap="round"/>
    <path d="M65.5 34 h5 l-2.5 3 Z" fill="#5C4148"/>
    <text x="84" y="16" font-size="12" font-weight="800" fill="#3B2E4A">z</text>
    <text x="89" y="8" font-size="8" font-weight="800" fill="#3B2E4A">z</text>
  </symbol>
  <symbol id="tk-sleep-lulu" viewBox="0 0 96 56">
    <ellipse cx="44" cy="38" rx="33" ry="15" fill="#8B7A6C"/>
    <path d="M20 30 C26 26 36 25 44 27 C40 34 30 38 22 36 Z" fill="#5E4E44"/>
    <ellipse cx="56" cy="44" rx="9" ry="6" fill="#A9714A"/>
    <path d="M14 44 q20 9 38 3" stroke="#5E4E44" stroke-width="6" stroke-linecap="round" fill="none"/>
    <circle cx="68" cy="29" r="15" fill="#8B7A6C"/>
    <path d="M68 15 C74 14 80 18 82 24 C77 26 71 24 68 20 Z" fill="#A9714A"/>
    <path d="M58 19 L55 6 L67 13 Z" fill="#8B7A6C"/><path d="M78 19 L81 6 L69 13 Z" fill="#A9714A"/>
    <path d="M60 29 q3 3 6 0 M71 29 q3 3 6 0" stroke="#3B2E4A" stroke-width="2.2" fill="none" stroke-linecap="round"/>
    <path d="M65.5 34 h5 l-2.5 3 Z" fill="#D96A7A"/>
    <text x="84" y="16" font-size="12" font-weight="800" fill="#3B2E4A">z</text>
    <text x="89" y="8" font-size="8" font-weight="800" fill="#3B2E4A">z</text>
  </symbol>
  <symbol id="tk-sleep-ilona" viewBox="0 0 96 56">
    <ellipse cx="44" cy="38" rx="33" ry="15" fill="#E0A05A"/>
    <path d="M10 40 C6 30 14 22 24 24 C18 27 15 33 18 39 C21 33 27 30 32 32 C26 35 24 40 26 44 Z" fill="#E0A05A"/>
    <path d="M12 36 q3 -5 9 -6" stroke="#C2803E" stroke-width="3" stroke-linecap="round" fill="none"/>
    <circle cx="68" cy="29" r="15" fill="#E0A05A"/>
    <path d="M58 19 L54 5 L67 12 Z" fill="#E0A05A"/><path d="M78 19 L82 5 L69 12 Z" fill="#E0A05A"/>
    <path d="M57 12 l-3 -4 M79 12 l3 -4" stroke="#F6E2C4" stroke-width="2.4" stroke-linecap="round"/>
    <path d="M66 12 v6 M61 13 l2 5 M71 13 l-2 5" stroke="#C2803E" stroke-width="2.4" stroke-linecap="round"/>
    <path d="M60 29 q3 3 6 0 M71 29 q3 3 6 0" stroke="#3B2E4A" stroke-width="2.2" fill="none" stroke-linecap="round"/>
    <path d="M65.5 34 h5 l-2.5 3 Z" fill="#D96A7A"/>
    <text x="84" y="16" font-size="12" font-weight="800" fill="#3B2E4A">z</text>
    <text x="89" y="8" font-size="8" font-weight="800" fill="#3B2E4A">z</text>
...
</svg><header><div class="wrap nav-inner"><div class="brandbox"><a class="logo" href="home.html"><svg viewBox="0 0 46 32" aria-hidden="true" fill="none" stroke="currentColor" stroke-width="4.6" stroke-linecap="round" stroke-linejoin="round"><path d="M3 5 H23 M13 5 V27"/><path d="M29 5 V27 M42 5 L30.5 16 M32.4 14.4 L43 27"/></svg>Toddler <span>Kitties</span></a><div class="logo-sleep" aria-hidden="true"><svg viewBox="0 0 96 56" aria-hidden="true"><use href="#tk-sleep-baker"></use></svg><svg viewBox="0 0 96 56" aria-hidden="true"><use href="#tk-sleep-doc"></use></svg><svg viewBox="0 0 96 56" aria-hidden="true"><use href="#tk-sleep-lulu"></use></svg><svg viewBox="0 0 96 56" aria-hidden="true"><use href="#tk-sleep-ilona"></use></svg></div></div><nav aria-label="Main"><a href="home.html">Home</a><a href="baker.html">Baker</a><a href="doc.html">Doc</a><a href="lulu.html">Lulu</a><a href="ilona.html">Ilona</a><a href="books.html" class="active">Books</a><a href="shop.html">Shop</a><a href="about.html">About</a></nav></div></header><main id="main">
...
<section class="wrap">
  <div class="books">
    <div class="panel book rv" style="--accent:#B39DDB;--accent-ink:#6A4A9C"><svg class="art" viewBox="-6 -6 152 152" role="img" aria-hidden="true"><use href="#tk-baker"></use></svg><div><span class="num">Book One</span><h3>Mama Baker</h3><p><strong>How the first one chose us.</strong><br>Before the windowsill, before the name on the carrier. Told mostly in black and white, with one exception.</p><span class="pill">Being drawn now</span></div></div>
    <div class="panel book rv" style="--accent:#4468C4;--accent-ink:#33509E"><svg class="art" viewBox="-6 -6 152 152" role="img" aria-hidden="true"><use href="#tk-doc"></use></svg><div><span class="num">Book Two</span><h3>Doc</h3><p><strong>A very long drive, and a very loud passenger.</strong><br>It starts a long way from this house, and it does not start well.</p><span class="pill pill-soon">Outlined</span></div></div>
    <div class="panel book rv" style="--accent:#4E9B62;--accent-ink:#337A48"><svg class="art" viewBox="-6 -6 152 152" role="img" aria-hidden="true"><use href="#tk-lulu"></use></svg><div><span class="num">Book Three</span><h3>Lulu</h3><p><strong>She was home before anyone saw her.</strong><br>The garden had been eaten for weeks. Two cats already knew who was doing it, and neither of them said anything.</p><span class="pill pill-soon">Outlined</span></div></div>
    <div class="panel book rv" style="--accent:#F2C542;--accent-ink:#8F6206"><svg class="art" viewBox="-6 -6 152 152" role="img" aria-hidden="true"><use href="#tk-ilona"></use></svg><div><span class="num">Book Four</span><h3>Ilona</h3><p><strong>The one they called chill.</strong><br>A family lost, a father who stayed, and a phone call from the shelter that started all of this.</p><span class="pill pill-soon">Outlined</span></div></div>
    <div class="panel book book-wide rv" style="--accent:#FF8FB1;--accent-ink:#C2456E"><div><span class="num">Book Five</span><h3>The Cat Council</h3><p><strong>All four. One room. One long-overdue argument.</strong><br>The ensemble book &mdash; the one where everybody finally ends up on the same page.</p><span class="pill pill-soon">Someday</span></div></div>
  </div>
</section>
...
<section class="wrap"><div class="signup panel rv">
<h2>Tell me when Book One lands</h2>
<p class="lede">One email, when the book is actually finished &mdash; not when it is nearly finished.</p>
...
<p class="fine">Or follow along on <a href="https://www.instagram.com/toddlerkitties/">Instagram</a>.</p>
</div></section>
</main><section class="cat-menu" aria-label="Pick a cat"><div class="wrap"><div class="cat-row"><a class="cat-item ci-baker" href="baker.html"><svg viewBox="-6 -6 152 152" role="img" aria-hidden="true"><use href="#tk-baker"></use></svg><span class="cat-label">Baker</span></a><a class="cat-item ci-doc" href="doc.html"><svg viewBox="-6 -6 152 152" role="img" aria-hidden="true"><use href="#tk-doc"></use></svg><span class="cat-label">Doc</span></a><a class="cat-item ci-lulu" href="lulu.html"><svg viewBox="-6 -6 152 152" role="img" aria-hidden="true"><use href="#tk-lulu"></use></svg><span class="cat-label">Lulu</span></a><a class="cat-item ci-ilona" href="ilona.html"><svg viewBox="-6 -6 152 152" role="img" aria-hidden="true"><use href="#tk-ilona"></use></svg><span class="cat-label">Ilona</span></a><a class="cat-item ci-coat coat-link" href="about.html"><svg class="coat-mini" viewBox="0 0 320 470" role="img" aria-labelledby="coatT">
...
</g></svg><span class="cat-label">About</span></a></div></div></section><footer><div class="wrap"><p class="foot-motto">A toddler is just 4 cats in a trenchcoat.</p><div class="foot-meta"><span>&copy; 2026 Toddler Kitties</span><a href="https://www.instagram.com/toddlerkitties/">@toddlerkitties</a><a href="mailto:toddlerkitties@gmail.com">toddlerkitties@gmail.com</a></div></div></footer><script>/* ==========================================================================
