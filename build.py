...
def page(fn, title, desc, body, active=None, theme=None, chrome=True, rooted=False):
...
'''
    ...
    if chrome:
        parts.append(cat_menu(exclude=theme))
        parts.append(footer())
    parts.append(JS + "\n</body>\n</html>\n")
    out = "".join(parts)
    if rooted:
...
def crew_card(slug, name, code, role, line):
    return (f'<a class="panel card card-{slug} rv" href="{slug}.html">'
            f'{cat_svg(slug, "art")}'
            f'<h3>{name}</h3><span class="role">{code} &middot; {role}</span>'
            f'<p>{line}</p></a>')
...
COAT = '''<svg class="coat" viewBox="0 0 320 470" role="img" aria-labelledby="coatT">
<title id="coatT">Four cartoon cats stacked inside one trenchcoat</title>
<g id="coatWobble">
  <g id="hat">
    <ellipse cx="160" cy="52" rx="76" ry="15" fill="#4A3A2C" stroke="#3B2E4A" stroke-width="4"/>
    <path d="M112 52 C112 22 130 12 160 12 C190 12 208 22 208 52 Z" fill="#5C4835" stroke="#3B2E4A" stroke-width="4"/>
    <path d="M112 45 h96 v8 h-96 Z" fill="#33281E"/>
  </g>
  <g><svg x="104" y="46" width="112" height="112" viewBox="-6 -6 152 152"><use href="#tk-baker"></use></svg></g>
  ...
  <g><svg x="128" y="188" width="64" height="64" viewBox="-6 -6 152 152"><use href="#tk-doc"></use></svg></g>
  <g><svg x="130" y="252" width="60" height="60" viewBox="-6 -6 152 152"><use href="#tk-lulu"></use></svg></g>
  <g><svg x="130" y="312" width="60" height="60" viewBox="-6 -6 152 152"><use href="#tk-ilona"></use></svg></g>
  ...
  <g id="tailOut"><path d="M228 424 C266 424 286 400 274 372 C288 392 280 414 260 420 C272 412 274 400 268 392 C270 408 250 416 232 416 Z" fill="#E0A05A" stroke="#3B2E4A" stroke-width="4" stroke-linejoin="round"/></g>
  <ellipse cx="124" cy="452" rx="24" ry="13" fill="#F6EFE2" stroke="#3B2E4A" stroke-width="4"/>
  <ellipse cx="196" cy="452" rx="24" ry="13" fill="#F6EFE2" stroke="#3B2E4A" stroke-width="4"/>
</g></svg>
<style>
...
<div class="oops wrap"><div class="oops-in">
  ...
  <p class="lede">Ilona was in the area shortly beforehand. That&rsquo;s all anyone can prove.</p>
  <a class="btn" href="home.html">Take me home</a>
</div></div>
'''
