...
<g class="coat-anim">
  ...
  <clipPath id="coatGap"><path d="M142 196 L178 196 L176 372 L144 372 Z"/></clipPath>
  <g id="coatPeek" clip-path="url(#coatGap)"></g>
...
GARDEN = '''<svg class="stage-garden" viewBox="0 0 360 88" role="img" aria-labelledby="gdnT" preserveAspectRatio="xMidYMax meet">
<title id="gdnT">A little garden along the bottom of the picture</title>
<g stroke="#2A2432" stroke-width="8.5" stroke-linecap="round" fill="none">
  <path d="M10 88 C8 72 14 62 22 55"/><path d="M24 88 C24 74 20 65 13 59"/>
  <path d="M62 88 C60 73 66 63 74 56"/><path d="M76 88 C76 75 72 66 66 61"/>
  <path d="M132 88 C130 74 136 66 143 60"/><path d="M146 88 C146 76 142 68 137 63"/>
  <path d="M214 88 C212 74 218 66 225 60"/><path d="M228 88 C228 76 224 68 219 63"/>
  <path d="M286 88 C284 73 290 63 298 56"/><path d="M300 88 C300 75 296 66 290 61"/>
  <path d="M344 88 C342 72 348 62 355 56"/>
</g>
<g stroke="#4E9B62" stroke-width="5" stroke-linecap="round" fill="none">
  <path d="M10 88 C8 72 14 62 22 55"/><path d="M24 88 C24 74 20 65 13 59"/>
  <path d="M62 88 C60 73 66 63 74 56"/><path d="M76 88 C76 75 72 66 66 61"/>
  <path d="M132 88 C130 74 136 66 143 60"/><path d="M146 88 C146 76 142 68 137 63"/>
  <path d="M214 88 C212 74 218 66 225 60"/><path d="M228 88 C228 76 224 68 219 63"/>
...
<g class="gdn-sway gdn-1">
  <path d="M44 88 V44" stroke="#337A48" stroke-width="4.6" stroke-linecap="round"/>
  <path d="M44 66 q-11 -3 -14 -12 q12 -1 14 8Z" fill="#4E9B62" stroke="#2A2432" stroke-width="2.4" stroke-linejoin="round"/>
  <g fill="#FFFFFF" stroke="#2A2432" stroke-width="2.4">
    <ellipse cx="44" cy="32" rx="5" ry="9"/><ellipse cx="44" cy="50" rx="5" ry="9"/>
    <ellipse cx="35" cy="41" rx="9" ry="5"/><ellipse cx="53" cy="41" rx="9" ry="5"/>
  </g>
  <circle cx="44" cy="41" r="5.4" fill="#F2C542" stroke="#2A2432" stroke-width="2.4"/>
</g>
<g class="gdn-sway gdn-2">
  <path d="M104 88 V52" stroke="#337A48" stroke-width="4.6" stroke-linecap="round"/>
  <path d="M104 70 q12 -4 15 -12 q-13 -1 -15 8Z" fill="#4E9B62" stroke="#2A2432" stroke-width="2.4" stroke-linejoin="round"/>
  <g fill="#FF8FB1" stroke="#2A2432" stroke-width="2.4">
    <circle cx="104" cy="34" r="6.6"/><circle cx="95" cy="43" r="6.6"/>
    <circle cx="113" cy="43" r="6.6"/><circle cx="99" cy="53" r="6.6"/><circle cx="109" cy="53" r="6.6"/>
  </g>
  <circle cx="104" cy="44" r="5" fill="#F2C542" stroke="#2A2432" stroke-width="2.4"/>
</g>
<g class="gdn-sway gdn-3">
  <path d="M258 88 V50" stroke="#337A48" stroke-width="4.6" stroke-linecap="round"/>
  <path d="M258 68 q-11 -3 -14 -11 q12 -1 14 7Z" fill="#4E9B62" stroke="#2A2432" stroke-width="2.4" stroke-linejoin="round"/>
  <g fill="#FFFFFF" stroke="#2A2432" stroke-width="2.4">
    <ellipse cx="258" cy="34" rx="4.6" ry="8.4"/><ellipse cx="258" cy="51" rx="4.6" ry="8.4"/>
    <ellipse cx="249" cy="42.5" rx="8.4" ry="4.6"/><ellipse cx="267" cy="42.5" rx="8.4" ry="4.6"/>
  </g>
  <circle cx="258" cy="42.5" r="5" fill="#F2C542" stroke="#2A2432" stroke-width="2.4"/>
</g>
<g class="gdn-sway gdn-4">
  <path d="M320 88 V56" stroke="#337A48" stroke-width="4.6" stroke-linecap="round"/>
  <path d="M320 72 q11 -3 14 -11 q-12 -1 -14 7Z" fill="#4E9B62" stroke="#2A2432" stroke-width="2.4" stroke-linejoin="round"/>
  <circle cx="320" cy="49" r="8" fill="#B79BE8" stroke="#2A2432" stroke-width="2.4"/>
  <circle cx="320" cy="49" r="3.2" fill="#F2C542"/>
</g>
</svg>'''


MOUNTAIN = '''<svg class="stage-garden" viewBox="0 0 360 104" role="img" aria-labelledby="mtnT" preserveAspectRatio="xMidYMax meet">
<title id="mtnT">A mountain valley with pines and a running stream</title>
<g stroke="#2A2432" stroke-width="3" stroke-linejoin="round">
  <path d="M-6 64 L26 20 L52 48 L66 34 L96 64 Z" fill="#8FA0A8"/>
  <path d="M26 20 L38 33 L32 36 L26 32 L20 36 L14 33 Z" fill="#F2F6F8"/>
  <path d="M264 64 L296 16 L322 46 L338 30 L366 64 Z" fill="#7E9199"/>
  <path d="M296 16 L308 30 L302 33 L296 29 L290 33 L284 30 Z" fill="#F2F6F8"/>
</g>
<g stroke="#2A2432" stroke-width="3" stroke-linejoin="round">
  <path d="M40 78 L26 78 L34 66 L28 66 L36 54 L30 54 L40 40 L50 54 L44 54 L52 66 L46 66 L54 78 L40 78 Z" fill="#3E7A42"/>
  <path d="M86 78 L76 78 L82 68 L78 68 L84 58 L80 58 L87 47 L94 58 L90 58 L96 68 L92 68 L98 78 L86 78 Z" fill="#4E9B62"/>
  <path d="M284 78 L270 78 L278 66 L272 66 L280 54 L274 54 L284 40 L294 54 L288 54 L296 66 L290 66 L298 78 L284 78 Z" fill="#3E7A42"/>
  <path d="M328 78 L318 78 L324 68 L320 68 L326 58 L322 58 L329 47 L336 58 L332 58 L338 68 L334 68 L340 78 L328 78 Z" fill="#4E9B62"/>
</g>
<g stroke="#2A2432" stroke-width="2.6" fill="#9AA6AC">
  <ellipse cx="118" cy="76" rx="13" ry="7"/><ellipse cx="240" cy="75" rx="11" ry="6"/>
</g>
<g stroke="#4E9B62" stroke-width="4.4" stroke-linecap="round" fill="none">
  <path d="M108 78 C106 70 110 64 116 60"/><path d="M132 78 C132 70 128 65 122 62"/>
  <path d="M226 78 C224 70 228 64 234 60"/><path d="M252 78 C252 70 248 65 242 62"/>
</g>
<path d="M0 78 C60 74 100 82 180 80 C260 78 300 74 360 78 L360 104 L0 104 Z" fill="#5FA8C4" stroke="#2A2432" stroke-width="3"/>
<g class="mtn-flow" stroke="#BEE4F2" stroke-width="3.4" stroke-linecap="round" fill="none" opacity=".85">
  <path d="M-40 88 q16 -4 32 0 t32 0 t32 0 t32 0 t32 0 t32 0 t32 0 t32 0 t32 0 t32 0 t32 0 t32 0 t32 0"/>
</g>
<g class="mtn-flow mtn-flow-2" stroke="#E8F6FB" stroke-width="2.6" stroke-linecap="round" fill="none" opacity=".7">
  <path d="M-40 97 q16 4 32 0 t32 0 t32 0 t32 0 t32 0 t32 0 t32 0 t32 0 t32 0 t32 0 t32 0 t32 0 t32 0"/>
</g>
</svg>'''
...
MARK_SETS = {
 "cards":  [("&diams;", "s-red"), ("&hearts;", "s-red"),
            ("&clubs;", "s-blk"), ("&spades;", "s-blk")],
 "garden": [("&#10047;", "s-pink"), ("&#10048;", "s-green"),
            ("&#10049;", "s-pink"), ("&#10046;", "s-green")],
 "baker":  [("&#9787;", "s-purple"), ("&diams;", "s-red"), ("&hearts;", "s-red"),
            ("&#9786;", "s-purple"), ("&spades;", "s-blk"), ("&clubs;", "s-blk")],
}


def cat_page(slug, name, code, role, tagline, tally, story, book_no, quote, who, nxt,
             facts=None, facts_title=None, marks="cards", pronoun="Her", stage_extra=""):
    ns, nn = nxt
...
"""
    ...
    facts_block = ""
    if facts:
        mk = MARK_SETS.get(marks, MARK_SETS["cards"])
        cards = "".join(
            f'<li><span class="suit {mk[i % len(mk)][1]}" aria-hidden="true">{mk[i % len(mk)][0]}</span>'
            f'<span>{f}</span></li>'
            for i, f in enumerate(facts))
        facts_block = f'''
<section class="wrap">
  <div class="panel rv">
    <h2 style="margin-bottom:1rem">{facts_title or f"{name}&rsquo;s cool cat facts"}</h2>
    <ul class="facts">{cards}</ul>
  </div>
</section>
'''
...
<section class="wrap meet">
  <div class="stage rv" data-stage>{cat_svg(slug, "stage__cat", f"{name}, cartoon portrait", inline=True)}{stage_extra}</div>
  <div class="rv">
...
{tally_block}{facts_block}
<section class="wrap">
  <div class="panel rv">
    <span class="pill">Book {book_no}</span>
    <h2 style="margin:.7rem 0 .8rem">{pronoun} story, roughly</h2>
...
CAT_DATA = [
 dict(slug="baker", name="Baker", code="B1", role="The Judge", book_no="One",
   ...
   facts_title="Baker&rsquo;s favorite activities", marks="baker", tally=[],
   facts=["Baker guards her carrier because it clearly has her name on it. She knows it! (There is no name on it)",
          "Picked her human out of a whole room and has considered the matter settled ever since. The human had no say.",
          "Greeting fellow motorist on the freeway with a cute hellow.",
          "Has a heart-shaped nose, but denies having one.",
          "Has a war cry. It only means she wants to play. It took the household a while to work that out.",
          "Reigning Fight Club champion 5 years in a row."],
   story="Baker sits in a room full of other cats, and a decision she made without asking for anybody&rsquo;s permission.",
   quote="I saw the whole thing. I <em>was</em> the whole thing.",
   who="Baker, probably", nxt=("doc","Doc")),

 dict(slug="doc", name="Doc", code="D2", role="The Bailiff", book_no="Two", pronoun="His",
   tagline="The house&rsquo;s resident cool guy. Enormous ears, no urgency, and one very specific pom pom.",
   facts_title="Doc&rsquo;s cool cat facts",
   facts=["Fetch goblin. Will throw a pom pom around entirely by himself.",
          "Shoved a 30-pound box out of the way to reach that pom pom. Do not get between them.",
          "Sweetest boy around.",
          "Would like to be treated as a person, thank you.",
          "Loves bubble baths and his rubber ducky.",
          "Drinks water so fast he coughs and sneezes it back out.",
          "Contender in Fight Club.",
          "Wants to be one with his human. All of the time."],
   tally=[],
   story="Doc was a prowler at a motel. Meeting his forever Gramps, then a long drive north. Three long weeks of medicine on a kitchen counter, and a feisty baby boy.",
   quote="I said hello. I said it the whole way.",
   who="Doc, still talking", nxt=("lulu","Lulu")),

 dict(slug="lulu", name="Lulu", code="L3", role="Garden Kitty", book_no="Three", stage_extra=GARDEN,
   tagline="She was already home before anybody in the house had seen her.",
   facts_title="Lulu&rsquo;s cool cat facts", marks="garden", tally=[],
   facts=["Loves a good cucumber.",
          "Knows the luxuries of indoor life. She can use an AC.",
          "Loves to hold fingers like a toddler.",
          "Loves computers like a real girl.",
          "Sleeps like we have world peace.",
          "Loves to pet you."],
   story="Something was eating from our garden for weeks and slipping away behind the shed. Everybody suspected a raccoon. Everybody was wrong. It was I, Lulu.",
   quote="I&rsquo;d already been coming in. Nobody asked.",
   who="Lulu, mid-cucumber", nxt=("ilona","Ilona")),

 dict(slug="ilona", name="Ilona", code="I4", role="The Talker", book_no="Four", stage_extra=MOUNTAIN,
   tagline="Fourth in, loudest by a distance, and the first to notice when you&rsquo;re having a bad day.",
   facts_title="Ilona cool cat facts", marks="mountain", tally=[],
   facts=["Chose her own collar. She walked over, picked one up in her mouth, and chose it twice.",
          "Jabbers instantly once the door is closed. Any door. Immediately.",
          "Tries to open the bedroom doorknob. Sadly, she lacks the grip. She does not, however, lack the will.",
          "Will wait and complain at the closet door, three feet from the right door. When caught she looks embarrassed.",
          "Takes the extra shift whenever someone is sick, tired or sad. Every single time.",
          "Total daddy&rsquo;s girl."],
   story="Ilona is a full daddy&rsquo;s girl. When she was a baby her mom was taken by coyotes. Her dad saved her by bringing her food &mdash; which made the rescuers&rsquo; job hard, because the dad and Ilona did not need food. Once she was caught, her dad and her found their fosters. The dad went to a loving family, and Ilona joined ours.",
   quote="I have been saying this the entire time.",
   who="Ilona, still going", nxt=("baker","Baker")),
]
...
<section class="wrap">
  <div class="books">
    ...
    {book("lulu","Three","Lulu","She was home before anyone saw her.",
      "Something had been eating the garden for weeks. Everybody suspected a raccoon. Two cats already knew better, and neither of them said anything.", "Outlined")}
